...
def about(lang=None):
    ...
    parragraph1 = str(Content.get_value('about',lang,'parragraph1')['value'] or '')
    parragraph2 = str(Content.get_value('about',lang,'parragraph2')['value'] or '')
    parragraph3 = str(Content.get_value('about',lang,'parragraph3')['value'] or '')
    parragraph4 = str(Content.get_value('about',lang,'parragraph4')['value'] or '')
    parragraph5 = str(Content.get_value('about',lang,'parragraph5')['value'] or '')
    parragraph6 = str(Content.get_value('about',lang,'parragraph6')['value'] or '')
...
def contact(lang=None):
    ...
    subtitle = str(Content.get_value('contact',lang,'subtitle')['value'] or '')
    first_name = str(Content.get_value('contact',lang,'first_name')['value'] or '')
    last_name = str(Content.get_value('contact',lang,'last_name')['value'] or '')
    ...
    email_subject = str(Content.get_value('contact',lang,'email_subject')['value'] or '')
...
def login(lang=None): 
    ...
    form.username.label.text = str(Content.get_value('',lang,'username')['value'] or '')
    form.password.label.text = str(Content.get_value('',lang,'password')['value'] or '')
    form.remember_me.label.text = str(Content.get_value('',lang,'rememberme')['value'] or '')
    form.submit.label.text = str(Content.get_value('',lang,'signin')['value'] or '')
